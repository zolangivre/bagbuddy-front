// Généré depuis lucide-static v1.42.0 (ISC) — mêmes icônes que l'app mobile (lucide-react-native).
// Ne pas éditer à la main : régénérer si de nouvelles icônes sont nécessaires.
...
const RAW = {
  ...
  'notepad-text': [
    ...
    { tag: 'rect', attrs: { width: '16', height: '18', x: '4', y: '4', rx: '2' } },
...
export const ICONS: Record<IconName, readonly IconShape[]> = RAW;
